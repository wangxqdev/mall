...
import com.tec.anji.model.Data;
import com.tec.anji.model.MultiData;
...
public class HomeController {
    ...
    public Object getHomeMultiData() {
        ...
        List<Data> banners = new ArrayList<>();
        banners.add(banner1);
        banners.add(banner2);
        banners.add(banner3);
        banners.add(banner4);

        Map<String, List<Data>> bannersMap = new HashMap<>();
        bannersMap.put("list", banners);

        /* Recommend */
        Data recommend1 = new Data();
    ...
    public Object getHomeData(String type, int page) {
        ...
        for (int i = 0; i < 30; i++) {
            Data data = new Data();
            data.setImage("http://localhost:8090/img/timg.png");
            data.setLink("#");
            data.setTitle(String.format("%s女装%d%d", type, page, i));
            dataList.add(data);
        }
        ...
        Map<String, Map<String, List<Data>>> dataMap = new HashMap<>();
